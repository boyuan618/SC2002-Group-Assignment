...
public class BTOManager extends User{
    ...
    public BTOManager(String a, String b, int c, boolean d){
        super(a,b,c,d); this.inProject=false; currentProject=new BTOProject(); visibility=false; applicantList=null;} /*watch out for compilation error */
        ...
        currentProject=new BTOProject(projectName, neighborhood, type1, units1, price1, type2, units2, price2, openDate,
    ...
    public void editProjectListing(){} /*insert code */

    
    
    public void deleteProjectListing(){} /*insert code */

    
    
    public void toggle(){
        if(visibility==true){
            visibility=false; return;}
        visibility=true;}

    
    
        public void viewProjects(){} /*insertCode here */
    ...
    public void respondToOfficerRegistration(String name){
        ...
        if(currentProject.getOfficerSlot()!=0){
            ...
            System.out.println("Officer successfully registered!"); return;}
        ...
        if(requestedType.equals(currentProject.getType1())){
            if(currentProject.getUnits1()==0){
                ...
                return false;}
            /*code to add applicant into applicant list, need Applicant class. Need to include flat type too */
    ...
    public void generateListOfApplicants(){} /*insert code here */

    
    
    public void viewEnquiry(BTOProject project){} /*insert code here */

    
    
    public void respondToEnquiry(){} /*insert code here, use currentProject to code*/
